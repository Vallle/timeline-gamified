...
public class EmotionsProvider extends BaseContentProvider {
	...
	public static final Uri CONTENT_URI = Uri
			.parse("content://com.bjorsond.android.timeline.database.providers.emotionsprovider");

	private static HashMap<String, String> emotionsColumnMapping;
	
	public static final String AUTHORITY = "com.bjorsond.android.timeline.database.providers.emotionsprovider";
